...
const skills = [
    { name: "HTML/CSS", level: 80, category: "fronted" },
    { name: "Javascript", level: 50, category: "fronted" },
    { name: "React", level: 50, category: "fronted" },
    { name: "Tailwind CSS", level: 50, category: "fronted" },
...
export const SkillSection = () => {
    ...
    return (<section id='skill' className='py-24 px-4 relative bg-secondary/30 '>
        <div className='container mx-auto max-w-5xl ' id='skill'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                ...
                {filteredSkill.map((skill, key) => (
                    <div key={key} className='bg-card p-6 rounded-lg shadow-xs gradient-border  card-hover '>
